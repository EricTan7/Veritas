...
from detectors.utils.iid_api import l2_norm
...
class IIDDetector(AbstractDetector):
    def __init__(self, config):
        ...
        self.IIE_LOSS = FC_ddp2(config['embedding_size'], config["num_ids"], scale=64, margin=0.4, mode='arcface', use_cifp=False,
    ...
    def forward(self, data_dict: dict, inference=False) -> dict:
        ...
        loss_dict = self.get_losses(data_dict, pred_dict)
        pred_dict["loss"] = loss_dict
        return pred_dict
