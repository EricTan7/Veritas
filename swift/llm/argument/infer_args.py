...
class InferArguments(MergeArguments, VllmArguments, LmdeployArguments, BaseArguments):
    ...
    metric: Literal['acc', 'rouge', "self_acc", "self_acc_choice", "self_acc_tags", "self_acc_choice_tags", "self_acc_explain", "self_acc_flexible"] = None
    # for pt engine
    ...
    def _init_stream(self):
        self.eval_human = not (self.dataset and self.split_dataset_ratio > 0 or self.val_dataset or self.val_dataset_split)
