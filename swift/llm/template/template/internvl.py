...
class Internvl2Template(InternvlTemplate):
    ...
    def _encode(self, inputs: StdTemplateInputs) -> Dict[str, Any]:
        ...
        if images:
            ...
            use_aug = get_env_args('use_aug', bool, False)
            aug = True if use_aug and self.is_training else False
            pixel_values = [transform_image(image, input_size, max_num, aug=aug) for image in images]
